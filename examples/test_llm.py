...
args = ["main", "text", "tasc", "--model", "llama3", "--speaker", "student_normalized.wav", "--transcription", "transcription.vtt",
        "--segmentation", "segmentation.vtt", "--overwrite"]
# Segmenting for .csv files
args = ["main", "text", "tasc", "--model", "llama3", "--speaker", "Reply", "--transcription", "transcription.csv",
