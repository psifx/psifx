"""OpenAI Whisper transcription command-line interface."""
import argparse
...
class OpenAIWhisperCommand(Command):
    """
    ...
    def setup(parser: argparse.ArgumentParser):
        ...
        register_command(subparsers, "inference", OpenAIWhisperInferenceCommand)
...
class OpenAIWhisperInferenceCommand(Command):
    """
    Command-line interface for transcribing an audio track with OpenAI Whisper.
    """
